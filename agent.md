...
## Version History
- **v1.4.2**: Removed role restriction for opening the sync admin section to solve role promotion catch-22, and relaxed backend API gating to allow all SSO users to call the force sync.
